...
<head>
    ...
    <link rel="icon" href="{{asset('/pictures/FONDO_ARMORUM_VU_SGDEA.png')}}" type="image/x-icon">
...
<div class="header">
    <div class="title">
        ...
        <div class="logos">
            <div class="logo">
            <img class="alcaldia" src="{{asset('/pictures/logo_duitama.jpg')}}" alt="Logo Duitama">
            <!-- <img class="alcaldia" src="http://verificacertificados.test/pictures/logo_duitama.jpg" alt="Logo Duitama"> -->
            </div>
            <div class="logo">
            <img class="armorum" src="{{asset('/pictures/FONDO_ARMORUM_VU_SGDEA.png')}}" alt="Logo Armorum">
...
<img src="{{asset('/pictures/check_verificacion-removebg-preview.png')}}" alt="">
<!-- <img src="http://verificacertificados.test/pictures/check_verificacion-removebg-preview.png" alt=""> -->
    <div class="info">
        ...
        <div class="items" id="cod_pred">
            ...
            <div class="contenido">
                <span id="cod_p">{{$content->cod_p }}</span>
            </div>
        </div>
    </div>
</div>
